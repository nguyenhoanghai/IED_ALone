...
GPRO.namespace('PhantichByCust');
GPRO.PhantichByCust = function () {
    var Global = {
        UrlAction: {
    ...
    var RegisterEvent = function () {
        $('[re-select-product-group]').click(function () {
            GetCustomerSelect('select-product-type')
        });
        ...
        $('[re-select-product]').click(function () {
            GetProductSelectByProGroup($('#select-product-type').val(), 'select-product', true);
        });
