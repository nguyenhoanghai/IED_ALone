...
namespace GPRO_IED_A.Business
{
    public class BLLRolePermission
    {
        ...
        public List<string> GetListSystemNameAndUrlOfPermissionByListRoleId(List<int> listRoleId, IEDEntities db)
        {
        ...
        public List<ModelPermission> GetListPermissionByListRoleId(List<int> listRoleId, IEDEntities db)
        {
            ...
            try
            {
                if (listRoleId != null && listRoleId.Count > 0)
                {
                    var permissionIds = (from x in db.SRolePermissions
                    ...
                    {
                        listPermission = (from x in db.SPermissions
        ...
        public List<string> GetListSystemNameAndUrlOfPermissionByListRoleId(List<int> listRoleId, int moduleId, IEDEntities db)
        {
            List<string> systemNameUrlPermission = null;
            try
            {
        ...
        public List<ModelPermission> GetListPermissionByListRoleId(List<int> listRoleId, int moduleId, IEDEntities db)
        {
            List<ModelPermission> listPermission = null;
            try
            {
                if (listRoleId != null && listRoleId.Count > 0)
                {
                    var permissionIds = (from x
                                         ...
                                         select x.PermissionId).Distinct();
                    var per = (from x in db.SRolePermissions
        ...
        public List<ModelFeature> GetListFeatureByModuleIdOfRoles(List<int> listRoleId, int moduleId, IEDEntities db)
        {
            List<ModelFeature> listFeature = null;
            try
            {
        ...
        public List<int> GetListModuleIdByListRoleId(List<int> RoleIds, IEDEntities db)
        {
            try
            {
                if (RoleIds != null || RoleIds.Count > 0)
                {
                    return (from x in db.SRolePermissions where !x.IsDeleted && RoleIds.Contains(x.RoleId) select x.ModuleId).ToList();
                }
                else
                    return null;
            }
        ...
        public List<string> GetSystemNameAndUrlOfPermissionBycompanyId(int companyId, IEDEntities db)
        {
            try
            {
                List<string> systemNameUrlPermission = null;
